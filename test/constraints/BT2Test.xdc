...
set_property PACKAGE_PIN T1 [get_ports {connect_slave}]
    set_property IOSTANDARD LVCMOS33 [get_ports {connect_slave}]
set_property PACKAGE_PIN R2 [get_ports {connect_master}]
    set_property IOSTANDARD LVCMOS33 [get_ports {connect_master}]
...
# set_property PACKAGE_PIN P3 [get_ports {motorLED[12]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {motorLED[12]}]
# set_property PACKAGE_PIN N3 [get_ports {motorLED[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {motorLED[0]}]
# set_property PACKAGE_PIN P1 [get_ports {led_left[0]}]
# set_property IOSTANDARD LVCMOS33 [get_ports {led_left[0]}]
# set_property PACKAGE_PIN L1 [get_ports {led_left[1]}]
...
#* Pmod Header JB
# # Sch name = JB1
# set_property PACKAGE_PIN A14 [get_ports {master_rts}]
#     set_property IOSTANDARD LVCMOS33 [get_ports {master_rts}]
# Sch name = JB2
set_property PACKAGE_PIN A16 [get_ports {master_rx}]
    set_property IOSTANDARD LVCMOS33 [get_ports {master_rx}]
# Sch name = JB3
set_property PACKAGE_PIN B15 [get_ports {master_tx}]
    set_property IOSTANDARD LVCMOS33 [get_ports {master_tx}]
# # Sch name = JB4
set_property PACKAGE_PIN B16 [get_ports {master_cts}]
    set_property IOSTANDARD LVCMOS33 [get_ports {master_cts}]
# # Sch name = JB7
...
## Pmod Header JC
# # Sch name = JC1
# set_property PACKAGE_PIN K17 [get_ports {slave_rts}]
#    set_property IOSTANDARD LVCMOS33 [get_ports {slave_rts}]
# Sch name = JC2
set_property PACKAGE_PIN M18 [get_ports {slave_rx}]
   set_property IOSTANDARD LVCMOS33 [get_ports {slave_rx}]
# Sch name = JC3
set_property PACKAGE_PIN N17 [get_ports {slave_tx}]
   set_property IOSTANDARD LVCMOS33 [get_ports {slave_tx}]
# Sch name = JC4
set_property PACKAGE_PIN P18 [get_ports {slave_cts}]
   set_property IOSTANDARD LVCMOS33 [get_ports {slave_cts}]
## Sch name = JC7
...
## USB-RS232 Interface
set_property PACKAGE_PIN B18 [get_ports computer_rx]
   set_property IOSTANDARD LVCMOS33 [get_ports computer_rx]
set_property PACKAGE_PIN A18 [get_ports computer_tx]
    set_property IOSTANDARD LVCMOS33 [get_ports computer_tx]
